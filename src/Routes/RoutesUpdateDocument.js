...
function RoutesUpdateDocument() {
    ...
    useEffect(() => {
        async function fetchDocument() {
            ...
            setDocumentDate(fetchedDocument.date.substring(0, 10)); // Ensure the date is in YYYY-MM-DD format
            ...
            setDocumentID(fetchedDocument._id);
        }
        fetchDocument();
    }, [id]);
    ...
    const handleTagKeyPress = (e) => {
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          await patchDocuments(documentID, documentData);
